...
GO
INSERT [dbo].[tbl_State] ([Id], [Code], [CountryId], [StateName], [TenantId], [ShortCode], [CreatedOn], [CreatedBy], [ModifiedOn], [ModifiedBy]) VALUES (2, N'GJ', 1, N'Gujarat', N'1', N'GJ', CAST(N'2018-09-09 02:21:16.193' AS DateTime), NULL, NULL, NULL)
GO
...
GO
INSERT [dbo].[tbl_Lookup] ([Id], [LookupGroup], [LookupName], [LookupCode], [LookupValue], [TenantId], [CreatedOn], [CreatedBy], [ModifiedOn], [ModifiedBy]) VALUES (6, N'ITReturnStatus', N'Pending', N'ITRSTATUS_PEN', N'Pending', N'1', CAST(N'2018-09-09 02:32:47.943' AS DateTime), NULL, NULL, NULL)
GO
INSERT [dbo].[tbl_Lookup] ([Id], [LookupGroup], [LookupName], [LookupCode], [LookupValue], [TenantId], [CreatedOn], [CreatedBy], [ModifiedOn], [ModifiedBy]) VALUES (8, N'ITReturnStatus', N'Filed', N'ITRSTATUS_Filed', N'Filed', N'1', CAST(N'2018-09-09 02:35:06.827' AS DateTime), NULL, NULL, NULL)
GO
INSERT [dbo].[tbl_Lookup] ([Id], [LookupGroup], [LookupName], [LookupCode], [LookupValue], [TenantId], [CreatedOn], [CreatedBy], [ModifiedOn], [ModifiedBy]) VALUES (10, N'AuditStatus', N'Pending', N'AUDSTATUS_PEN', N'Pending', N'1', CAST(N'2018-09-09 02:36:04.857' AS DateTime), NULL, NULL, NULL)
GO
INSERT [dbo].[tbl_Lookup] ([Id], [LookupGroup], [LookupName], [LookupCode], [LookupValue], [TenantId], [CreatedOn], [CreatedBy], [ModifiedOn], [ModifiedBy]) VALUES (11, N'AuditStatus', N'Filed', N'AUDSTATUS_FILED', N'Filed', N'1', CAST(N'2018-09-09 02:36:44.867' AS DateTime), NULL, NULL, NULL)
GO
SET IDENTITY_INSERT [dbo].[tbl_Lookup] OFF
GO
SET IDENTITY_INSERT [dbo].[tbl_FinancialYear] ON 
